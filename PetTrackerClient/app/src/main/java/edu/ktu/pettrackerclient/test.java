...
import edu.ktu.pettrackerclient.databinding.ActivityTestBinding;
...
public class test extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.drawerNav_deviceList, R.id.drawerNav_gpsFeatures)//, R.id.drawerNav_latest, R.id.drawerNav_history, R.id.drawerNav_radar)
