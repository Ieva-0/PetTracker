...
public class EditProfileTest {
    ...
    public void editProfile() throws InterruptedException {
        ...
        Espresso.onView(withId(R.id.register_email_1)).perform(typeText(name + "@n.m"));
        Espresso.pressBack();
        ...
        Thread.sleep(1000);
        onView(withId(R.id.account_editProfile)).perform(click());
        Thread.sleep(1000);
        onView(withId(R.id.editProfile_cancel)).perform(click());
        Thread.sleep(1000);
        onView(withId(R.id.account_editProfile)).perform(click());
        Thread.sleep(1000);
        onView(withId(R.id.editProfile_username_1)).perform(typeText("1"));
        Espresso.pressBack();
        onView(withId(R.id.editProfile_email_1)).perform(typeText("1"));
        Espresso.pressBack();
        onView(withId(R.id.editProfile_password_1)).perform(typeText(name));
        Espresso.pressBack();
        onView(withId(R.id.editProfile_save)).perform(click());
        Thread.sleep(1000);
        onView(withId(R.id.drawer_layout)).perform(DrawerActions.open());
